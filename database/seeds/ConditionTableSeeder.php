...
class ConditionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Condition::create([
            ...
            'opponent' => 'Robin',
            'title' => 'A2',
            'text_chain' => 'comp#You are going to play a game with another player, called Robin. In the context in which you and the other player play the game, players are usually cooperative, even though some players may not be. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen. In the context of this game, all MUs earned by both players in the game are added up and equally divided.<br><br>{{incentive_text}}<br><br>Robin is instructed to be competitive, meaning that Robin wants to get as many money units (MUs) as possible and for you to get as few MUs as possible.;coop#You are going to play a game with another player, called Robin. In the context in which you and the other player play the game, players are usually cooperative, even though some players may not be. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen. In the context of this game, all MUs earned by both players in the game are added up and equally divided.<br><br>{{incentive_text}}<br><br>Robin is instructed to be cooperative, meaning that Robin wants both players to get the same amount of MUs.;neut#You are going to play a game with another player, called Robin. In the context in which you and the other player play the game, players are usually cooperative, even though some players may not be. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen. In the context of this game, all MUs earned by both players in the game are added up and equally divided.<br><br>{{incentive_text}}<br><br>Robin is instructed to be sometimes cooperative and sometimes competitive.',
            ...
            'incentive' => 1,
            'incentive_text' => 'The MUs you receive are worth real money. At the end of each game (after 10 rounds), the MUs you receive for the last 10 rounds are converted into Dollar Cents at a specific rate and credited to your bonus account. Of course, if at the end of the experiment, you have nothing in your bonus account, you will not be paid a bonus, but you will not have to pay anything either. The test leader will pay out the bonus to you within two days after finishing the experiment.'
        ]);
        ...
        Condition::create([
            ...
            'opponent' => 'Robin',
            'title' => 'B2',
            'text_chain' => 'comp#You are going to play a game with another player, called Robin. In the context in which you and the other player play the game, players are usually cooperative, even though some players may not be. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen. In the context of this game, both players keep the MUs they individually earned in the game.<br><br>{{incentive_text}}<br><br>Robin is instructed to be competitive, meaning that Robin wants to get as many money units (MUs) as possible and for you to get as few MUs as possible.;coop#You are going to play a game with another player, called Robin. In the context in which you and the other player play the game, players are usually cooperative, even though some players may not be. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen. In the context of this game, both players keep the MUs they individually earned in the game.<br><br>{{incentive_text}}<br><br>Robin is instructed to be cooperative, meaning that Robin wants both players to get the same amount of MUs.;neut#You are going to play a game with another player, called Robin. In the context in which you and the other player play the game, players are usually cooperative, even though some players may not be. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen. In the context of this game, both players keep the MUs they individually earned in the game.<br><br>{{incentive_text}}<br><br>Robin is instructed to be sometimes cooperative and sometimes competitive.',
        ...
        Condition::create([
            ...
            'opponent' => 'Robin',
            'title' => 'F2',
            'text_chain' => 'comp#You are going to play a game with another player, called Robin. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen. In the context of this game, both players keep the MUs they individually earned.<br><br>{{incentive_text}}<br><br>Robin is instructed to be competitive, meaning that Robin wants to get as many money units (MUs) as possible and for you to get as few MUs as possible.;coop#You are going to play a game with another player, called Robin. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen. In the context of this game, both players keep the MUs they individually earned.<br><br>{{incentive_text}}<br><br>Robin is instructed to be cooperative, meaning that Robin wants both players to get the same amount of MUs.;neut#You are going to play a game with another player, called Robin. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen. In the context of this game, both players keep the MUs they individually earned.<br><br>{{incentive_text}}<br><br>Robin is instructed to be sometimes cooperative and sometimes competitive.',
            'text_division' => 'In this game, both players keep the MUs they individually earned. You receive {{user_gains}} MUs that are converted to real money and transferred to your bonus account. The other player received {{pc_gains}} MUs.',
            'incentive' => 1,
            'incentive_text' => 'The MUs you receive are worth real money. At the end of each game (after 10 rounds), the MUs you receive for the last 10 rounds are converted into Dollar Cents at a specific rate and credited to your bonus account. Of course, if at the end of the experiment, you have nothing in your bonus account, you will not be paid a bonus, but you will not have to pay anything either. The test leader will pay out the bonus to you within two days after finishing the experiment.'
        ]);
        ...
        Condition::create([
            ...
            'opponent' => 'Robin',
            'title' => 'G2',
            'text_chain' => 'comp# You are going to play a game with another player, called Robin. In the context in which you and the other player play the game, players are usually cooperative, even though some players may not be. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen.<br><br>{{incentive_text}}<br><br>Robin is instructed to be competitive, meaning that Robin wants to get as many money units (MUs) as possible and for you to get as few MUs as possible.;coop# You are going to play a game with another player, called Robin. In the context in which you and the other player play the game, players are usually cooperative, even though some players may not be. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen.<br><br>{{incentive_text}}<br><br>Robin is instructed to be cooperative, meaning that Robin wants both players to get the same amount of MUs.;neut#You are going to play a game with another player, called Robin. In the context in which you and the other player play the game, players are usually cooperative, even though some players may not be. The money units (MUs) that you earn in every round, are shown in the table displayed on the left of your screen.<br><br>{{incentive_text}}<br><br>Robin is instructed to be sometimes cooperative and sometimes competitive.',
